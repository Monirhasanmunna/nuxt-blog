                    ...
                    <tbody class="divide-y divide-gray-300 dark:divide-gray-700 ">
                        <tr v-for="(item, index) in items" :key="index">
                            ...
                            <td class="py-2 whitespace-nowrap text-[13px] text-gray-800 dark:text-gray-200">
                                <span v-if="item.status == 'active'" class="bg-green-600 text-white px-2 py-1 hover:bg-transparent hover:text-green-600 border hover:border-green-600 duration-150 text-center rounded-full capitalize">{{ item.status}}</span>
                                <span v-else class="bg-red-600 text-white text-center px-2 py-1 hover:bg-transparent hover:text-red-600 border hover:border-red-600 duration-150 rounded-full capitalize">{{ item.status}}</span>
                            </td>
